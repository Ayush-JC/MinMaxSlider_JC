...
namespace Min_Max_Slider
{
	...
	public class MinMaxSlider : Selectable, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		[SerializeField] private InputField minTextInputField = null;
		[SerializeField] private InputField maxTextInputField = null;
		...
		{
            if (minTextInputField)
                minTextInputField.text = minValue.ToString();

            if (maxTextInputField)
                maxTextInputField.text = maxValue.ToString();
		...
		private void UpdateMiddleGraphic()
		{
			...
			float middleGraphicFitOffset = 0.28f;
			middleGraphic.anchorMin = new Vector2(0, middleGraphicFitOffset);
			middleGraphic.anchorMax = new Vector2(1, 1-middleGraphicFitOffset);
